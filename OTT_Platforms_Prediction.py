...
with tab1:
    st.subheader("Project Instructions & Overview")

    st.markdown("""
    ### **Goal of the Project:**
    The primary goal of this project is to predict the IMDb rating of new content using data from both Netflix and IMDb sources.  
